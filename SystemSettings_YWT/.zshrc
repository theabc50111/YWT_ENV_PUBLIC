...
export TERM=xterm-256color  # The TERM variable tells the terminal emulator the type of terminal being used so that it knows how to interpret and display the output of programs that run in the terminal.

# ZSH-comopletions setting
